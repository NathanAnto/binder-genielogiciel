 ...
 */
export async function newBooking(user_id: number, book: Book): Promise<void> {
    try {
 ...
 */
export async function getBookings(user_id: number): Promise<any> {
    try {
 ...
 */
export async function returnBooking(booking_id: number): Promise<void> {
    try {
 ...
 */
export async function extendBooking(booking_id: number): Promise<void> {
    try {
